...
| TransferFrom insufficient allowance reverts | `transferFrom_insufficient_allowance_reverts` | ✓ Proved |
...
| Cannot drain pool below minimum | (require check) | ✓ Enforced |
...
| Property | Theorem | Status |
|----------|---------|--------|
| Zero deposit reverts | `vault_zero_deposit_reverts` | ✓ Proved |
| Insufficient balance reverts | `vault_insufficient_balance_reverts` | ✓ Proved |
